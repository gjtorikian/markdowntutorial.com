  ...
  root.lessons = {
    1: {
      0: {
        ...
        renderedAnswer:
          "<p>Pisanie w Markdownie <em>nie</em> jest takie trudne!</p>",
      },
      1: {
      ...
      2: {
        startingText:
          '"Oczywiście," szepnęła. Potem krzyknęła: "Potrzebuję tylko małego Moxie!"',
        renderedAnswer:
          '<p>"<em>Oczywiście</em>," szepnęła. Potem krzyknęła: "Potrzebuję tylko <strong> małego Moxie</strong>!"</p>',
      },
      3: {
        startingText:
          "Jeśli myślisz sobie, To jest niedowierzalne, to prawdopodnie masz rację.",
        renderedAnswer:
          "<p>Jeśli myślisz sobie, <strong><em>To jest niedowierzalne</em></strong>, to prawdopodnie masz rację.</p>",
      },
    },
    2: {
      0: {
      ...
      1: {
        startingText:
          "Symbolika kolumbijska w stu latach samotności\n\nOto kilka słów o książce _Sto lat..._.",
        renderedAnswer:
          "<h4>Symbolika kolumbijska w <em>stu latach samotności</em></h4>\n<p>Oto kilka słów o książce <em>Sto lat...</em>.</p>",
      },
    },
    3: {
      0: {
        ...
        renderedAnswer:
          '<p><a href="http://www.google.com">Poszukaj tego.</a></p>',
      },
      1: {
        startingText: "Ty bardzo, bardzo będziesz chciał to zobaczyć.",
        renderedAnswer:
          '<p><a href="http://www.dailykitten.com">Ty <strong>bardzo, bardzo</strong> będziesz chciał to zobaczyć.</a></p>',
      },
      2: {
        startingText: "Najnowsze informacje od BBC",
        renderedAnswer:
          '<h4>Najnowsze informacje od <a href="http://www.bbc.com/news">BBC</a></h4>',
      },
      3: {
        startingText:
          "Chcesz [zobaczyć coś fajnego][]?\n\nMam dla Ciebie [stronę][inne fajne miejsce]!",
        renderedAnswer:
          '<p>Chcesz <a href="http://www.zombo.com">zobaczyć coś fajnego</a>?</p>\n<p>Mam dla Ciebie <a href="http://www.stumbleupon.com">stronę</a>!</p>',
      },
    },
    4: {
      0: {
        ...
        renderedAnswer:
          '<p><img src="https://upload.wikimedia.org/wikipedia/commons/5/56/Tiger.50.jpg" alt="Piękny tygrys"></p>',
      },
      1: {
        startingText:
          "[Czarny kot][]\n\n[Pomarańczowy kot][Pomarańczowy]\n\n[Czarny]: https://upload.wikimedia.org/wikipedia/commons/a/a3/81_INF_DIV_SSI.jpg",
        renderedAnswer:
          '<p><img src="https://upload.wikimedia.org/wikipedia/commons/a/a3/81_INF_DIV_SSI.jpg" alt="Czarny kot"></p>\n<p><img src="https://upload.wikimedia.org/wikipedia/commons/4/4f/Kitty_emoji.png" alt="Pomarańczowy kot"></p>',
      },
    },
    5: {
      0: {
        startingText:
          'Któregoś dnia przeczytałem ciekawy cytat:\n\n"Jej oczy go wołały, a jego dusza podskoczyła na to wołanie. Żyć, błądzić, upaść, triumfować, odtworzyć życie z życia!"',
        renderedAnswer:
          '<p>Któregoś dnia przeczytałem ciekawy cytat:</p>\n<blockquote>\n<p>"Jej oczy go wołały, a jego dusza podskoczyła na to wołanie. Żyć, błądzić, upaść, triumfować, odtworzyć życie z życia!"</p>\n</blockquote>',
      },
      1: {
        startingText:
    ...
    6: {
      ...
      1: {
        startingText:
          "Ser pokroić, pomidory pokroić w plasterki, pomidory natrzeć w mące",
        renderedAnswer:
