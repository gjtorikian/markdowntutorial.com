  ...
  root.lessons = {
    1: {
      0: {
        ...
        renderedAnswer: "<p>Tekst opmaken in Markdown is <em>niet</em> moeilijk!</p>"
      },
      1: {
        startingText: "Ik maak alle lessen in deze lessenserie!",
        renderedAnswer: "<p>Ik <strong>maak</strong> alle lessen in deze lessenserie!</p>"
      },
      2: {
        startingText: "\"Natuurlijk,\" fluisterde ze. En toen, schreeuwde ze: \"Het enige dat ik wil is Cola!\"",
        renderedAnswer: "<p>\"<em>Natuurlijk</em>,\" fluisterde ze. En toen, schreeuwde ze \"Het enige dat ik wil is <strong>Cola!</strong>!\"</p>"
      },
      3: {
        startingText: "Als je denkt, dit kan niet... Dan heb je waarschijnlijk ongelijk!",
        renderedAnswer: "<p>Als je denkt, dit kan niet... <strong><em>Dan heb je waarschijnlijk gelijk!</em></strong></p>"
      }
    },
    2: {
      0: {
        startingText: "Koptest 1\nKoptest 2\nKoptest 3\nKoptest 4\nKoptest 5\nKoptest 6",
        renderedAnswer: "<h1>Koptest 1</h1>\n<h2>Koptest 2</h2>\n<h3>Koptest 3</h3>\n<h4>Koptest 4</h4>\n<h5>Koptest 5</h5>\n<h6>Koptest 6</h6>"
      },
      1: {
        startingText: "Van de maan af gezien zijn we allen even groot.\n\nUit het boek _Multatuli..._",
        renderedAnswer: "<h4>Van de maan af gezien zijn we allen even groot.</h4>\n<p>Uit het boek <em>_Multatuli..._ .</em>.</p>"
      }
    },
    3: {
      0: {
        startingText: "Zoek het maar uit()",
        renderedAnswer: "<p><a href=\"https://www.google.com\">Zoek het maar uit</a></p>"
      },
      1: {
      ...
      2: {
        ...
        renderedAnswer: "<h4>THet nieuwste nieuws van <a href=\"https://www.nos.nl\">NOS</a></h4>"
      },
      3: {
        startingText: "Wil je [een toffe plaats zien][]?\n\nKijk eens naar een plek [speciaal voor jou][link2]!",
        renderedAnswer: "<p>Wil je <a href=\"http://www.roermond.nl\">een toffe plaats zien?</a></p>\n<pKijk eens naar een plek <a href=\"http://www.limburg.nl\">speciaal voor jou</a>!</p>"
    ...
    4: {
      0: {
        ...
        renderedAnswer: "<p><img src=\"https://upload.wikimedia.org/wikipedia/commons/5/56/Tiger.50.jpg\" alt=\"Een knappe kat\"></p>"
      },
      1: {
    ...
    6: {
      ...
      1: {
        startingText: "Snij de kaas in blokjes, Snij de tomaten,haal de tomaten door het bloem",
